...
import { CompetitionComponent } from './public/components/media/competition/competition.component';
import { MediaComponent } from './public/components/media/media/media.component';
import { WallpapersComponent } from './public/components/media/wallpapers/wallpapers.component';
    ...
    // Core Scouting Routes (scouting-bundle)
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadComponent: () => import('./scouting/admin/components/manage-season/manage-season.component').then(mod => mod.ManageSeasonComponent),
            },
            {
                path: 'admin/schedule',
            ...
            },
            {
                ...
                loadComponent: () => import('./scouting/admin/components/manage-field-questions/manage-field-questions.component').then(mod => mod.ManageFieldQuestionsComponent),
            },
            {
                path: 'admin/manage-field-form',
                title: 'Scout Admin Field Form',
                loadComponent: () => import('./scouting/admin/components/manage-field-form/manage-field-form.component').then(mod => mod.ManageFieldFormComponent),
            },
            {
                path: 'admin/manage-field-question-aggregates',
                title: 'Scout Admin Field Question Aggregates',
                loadComponent: () => import('./scouting/admin/components/manage-field-question-aggregates/manage-field-question-aggregates.component').then(mod => mod.ManageFieldQuestionAggregatesComponent),
            },
            {
                path: 'admin/manage-field-question-conditions',
                title: 'Scout Admin Field Question Conditions',
                loadComponent: () => import('./scouting/admin/components/manage-field-question-conditions/manage-field-question-conditions.component').then(mod => mod.ManageFieldQuestionConditionsComponent),
            },
            {
                path: 'admin/manage-field-flows',
                title: 'Scout Admin Field Flows',
                loadComponent: () => import('./scouting/admin/components/manage-field-flows/manage-field-flows.component').then(mod => mod.ManageFieldFlowsComponent),
            },
            {
                path: 'admin/manage-field-flow-conditions',
                title: 'Scout Admin Field Flow Conditions',
                loadComponent: () => import('./scouting/admin/components/manage-field-flow-conditions/manage-field-flow-conditions.component').then(mod => mod.ManageFieldFlowConditionsComponent),
            },
            {
                path: 'admin/manage-field-responses',
                title: 'Scout Admin Field Responses',
                loadComponent: () => import('./scouting/admin/components/manage-field-responses/manage-field-responses.component').then(mod => mod.ManageFieldResponsesComponent),
            },
            {
                path: 'admin/manage-pit-questions',
                title: 'Scout Admin Pit Questions',
                loadComponent: () => import('./scouting/admin/components/manage-pit-questions/manage-pit-questions.component').then(mod => mod.ManagePitQuestionsComponent),
            },
            {
                path: 'admin/manage-pit-question-conditions',
                title: 'Scout Admin Pit Question Conditions',
                loadComponent: () => import('./scouting/admin/components/manage-pit-question-conditions/manage-pit-question-conditions.component').then(mod => mod.ManagePitQuestionConditionsComponent),
            },
            {
                path: 'admin/manage-pit-responses',
                title: 'Scout Admin Pit Responses',
                loadComponent: () => import('./scouting/admin/components/manage-pit-responses/manage-pit-responses.component').then(mod => mod.ManagePitResponsesComponent),
            },
            {
                path: 'admin/graph-admin-form',
                title: 'Scout Admin Graph Admin',
                loadComponent: () => import('./scouting/admin/components/graph-admin-form/graph-admin-form.component').then(mod => mod.GraphAdminFormComponent),
            },
        ]
    },
    ...
    // Admin Routes (admin-bundle)
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadComponent: () => import('./admin/components/meetings/meetings.component').then(mod => mod.MeetingsComponent),
            },
            {
                path: 'error-log',
                title: 'Admin Error Log',
                loadComponent: () => import('./admin/components/error-log/error-log.component').then(mod => mod.ErrorLogComponent),
            },
            {
                path: 'phone-types',
            ...
            },
            {
                ...
                loadComponent: () => import('./admin/components/requested-items/requested-items.component').then(mod => mod.RequestedItemsComponent),
            },
            {
                path: 'security',
                title: 'Admin Security',
                loadComponent: () => import('./admin/components/security/security.component').then(mod => mod.SecurityComponent),
            },
            {
                path: 'team-application-form',
                title: 'Admin Team Application',
                loadComponent: () => import('./admin/components/team-application-form/team-application-form.component').then(mod => mod.TeamApplicationFormComponent),
            },
            {
                path: 'team-contact-form',
                title: 'Admin Team Contact',
                loadComponent: () => import('./admin/components/team-contact-form/team-contact-form.component').then(mod => mod.TeamContactFormComponent),
            },
        ]
    },
