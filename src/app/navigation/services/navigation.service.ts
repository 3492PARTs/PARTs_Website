...
export class NavigationService {
  ...
  readonly allSubPages = [[
    ...
    new Link('Field Scouting', '/scouting/admin/manage-field-questions', 'soccer-field'),
    ...
    new Link('Pit Scouting', '/scouting/admin/manage-pit-questions', 'frequently-asked-questions'),
