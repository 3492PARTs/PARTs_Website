...
export class NavigationService {
  ...
  readonly allSubPages = [[
    ...
    new Link('Seasons', '/scouting/admin/manage-season', 'card-bulleted-settings-outline'),
    new Link('Field', '/scouting/admin/manage-field-questions', 'soccer-field'),
    ...
    new Link('Pit', '/scouting/admin/manage-pit-questions', 'frequently-asked-questions'),
